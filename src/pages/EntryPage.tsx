    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-stone-100 to-stone-200 px-4">
      <Card padding="p-8" className="w-full max-w-md">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link
            to="/admin/login"
            className="flex-1 px-6 py-4 text-center font-medium text-white bg-primary-600 rounded-lg shadow-sm hover:bg-primary-700 focus:ring-2 focus:ring-offset-2 focus:ring-primary outline-none transition duration-200"
          >
            Admin
          </Link>
          <Link
            to="/team/login"
            className="flex-1 px-6 py-4 text-center font-medium text-stone-700 bg-white border border-stone-300 rounded-lg shadow-sm hover:bg-stone-50 focus:ring-2 focus:ring-offset-2 focus:ring-primary outline-none transition duration-200"
          >
            Team
          </Link>
        </div>
